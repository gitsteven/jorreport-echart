...
/*    */ 
/*    */ public class TwinAxisLineTabShell extends Tabs
/*    */ {
...
/* 54 */     this.lo = new LineOption();
/* 55 */     this.lo.setChart(this.chart);
/* 56 */     this.lo.setObject(null);
/* 57 */     this.lo.addChangeListener(this);
...
/* 63 */     this.tp.add(this.lo, PanelLabelMap.getLabel(this.chart) + "选项");
/*    */   }
/*    */ 
/*    */   protected void refershTabContent() {
/* 67 */     this.tp.remove(this.lo);
/* 68 */     this.lo = new LineOption();
/* 69 */     this.lo.setChart(this.chart);
/* 70 */     this.lo.setObject(null);
/* 71 */     this.lo.addChangeListener(this);
/* 72 */     this.tp.add(this.lo, PanelLabelMap.getLabel(this.chart) + "选项");
/*    */   }
/*    */ }

/* Location:           G:\pilotproject\EnergyResourcesManager\jatools\lib\chart.jar
 * Qualified Name:     jatools.component.chart.customizer.TwinAxisLineTabShell
